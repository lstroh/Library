...
function sortBooksArrayStrings(str1,str2){
...
function sortBooksArrayBook(bool1,bool2){
    if(bool1 === bool2){
        return 0;
    } else if(bool1 === true){
        return -1;
...
function sortBooksArrayNumber(num1,num2){
    return (num1-num2);
}
...
function handleTrClick(e){
    ...
    if(pathArray[0] instanceof HTMLTableCellElement){
        if(pathArray[1].getAttribute("id") === "trHead"){
            var tdId = pathArray[0].getAttribute("id");
            switch (tdId) {
                case "thTitle":
                     booksArray.sort(function (book1,book2){
                        return sortBooksArrayStrings(book1.title,book2.title);
                    });
                    break;
                case "thAuthor":
                    booksArray.sort(function (book1,book2){
                        return sortBooksArrayStrings(book1.author,book2.author);
                    });
                    break;
                case "thPages":
                    booksArray.sort(function (book1,book2){
                        return sortBooksArrayNumber(book1.pages,book2.pages);
                    });
                    break;
                case "thRead":
                    booksArray.sort(function (book1,book2){
                        return sortBooksArrayBook(book1.read,book2.read);
                    });
                    break;
                default:
                    break;
...
var testBook = new Book("Fire and Fury: Inside the Trump White House","Michael Wolff",340,true);
var testBook2 = new Book("The Woman in the Window","A. J. Finn",448,false);
var testBook3 = new Book("The Last Jedi","Jason Fry",336,false);
